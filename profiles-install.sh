...
cp /home/travis/build/grails-profiles-tests/rest-api-plugin/build/grails-wrapper/wrapper/build/libs/grails-wrapper-1.0.1.BUILD-SNAPSHOT.jar $HOME/.grails/wrapper/grails-wrapper.jar
